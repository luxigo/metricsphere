...
template<class Real,int Type1,int Degree1,int Type2,int Degree2>
bool FiniteElements2D<Real,Type1,Degree1,Type2,Degree2>::LaplacianMatrix(int dim1,int dim2,double iWeight,SparseMatrix<Real>& m,bool weakForm,bool negate)
{
	return LaplacianMatrix(dim1,dim2,iWeight,m,0,Real(FiniteElements1D<Real,Type1,Degree1>::DomainSize(dim1)),0,Real(FiniteElements1D<Real,Type2,Degree2>::DomainSize(dim2)),weakForm,negate);
}
template<class Real,int Type1,int Degree1,int Type2,int Degree2>
bool FiniteElements2D<Real,Type1,Degree1,Type2,Degree2>::LaplacianMatrix(int dim1,int dim2,double iWeight,SparseMatrix<Real>& m,Real min1,Real max1,Real min2,Real max2,bool weakForm,bool negate)
{
	m.Resize(dim1*dim2);
	for(int i=0;i<dim1*dim2;i++) m.SetGroupSize(i,(2*Degree1+1)*(2*Degree2+1));
	SparseMatrix<Real> dot1,d2Dot1,dot2,d2Dot2;
...
{
	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::FullDotProductStencil dot1;
	FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::FullDotProductStencil dot2;
	FiniteElements1D<Real,DERIVATIVE(Type1),Degree1-1>::DotProduct<Type1,Degree1>::FullDotProductStencil d1;
	FiniteElements1D<Real,DERIVATIVE(Type2),Degree2-1>::DotProduct<Type2,Degree2>::FullDotProductStencil d2;

	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::DotProductStencil(dim1,dot1,0,0);
	FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::DotProductStencil(dim2,dot2,0,0);
	FiniteElements1D<Real,DERIVATIVE(Type1),Degree1-1>::DotProduct<Type1,Degree1>::DotProductStencil(FiniteElements1D<Real,DERIVATIVE(Type1),Degree1-1>::Dimension(FiniteElements1D<Real,Type1,Degree1>::DomainSize(dim1)),d1,0,1);
	FiniteElements1D<Real,DERIVATIVE(Type2),Degree2-1>::DotProduct<Type2,Degree2>::DotProductStencil(FiniteElements1D<Real,DERIVATIVE(Type2),Degree2-1>::Dimension(FiniteElements1D<Real,Type2,Degree2>::DomainSize(dim2)),d2,0,1);
...
{
	FiniteElements1D< Real , Type1 , Degree1 >::DotProduct< Type1 , Degree1 >::FullDotProductStencil dot1 , biLap1;
	FiniteElements1D< Real , Type2 , Degree2 >::DotProduct< Type2 , Degree2 >::FullDotProductStencil dot2 , biLap2;

	FiniteElements1D< Real , Type1 , Degree1 >::DotProduct< Type1 , Degree1 >::DotProductStencil( dim1 , dot1 , 0 , 0 );
	if( weakForm ) FiniteElements1D< Real , Type1 , Degree1 >::DotProduct< Type1 , Degree1 >::DotProductStencil( dim1 , biLap1 , 2 , 2 , negate );
	else           FiniteElements1D< Real , Type1 , Degree1 >::DotProduct< Type1 , Degree1 >::DotProductStencil( dim1 , biLap1 , 4 , 0 , negate );
	FiniteElements1D< Real , Type2 , Degree2 >::DotProduct< Type2 , Degree2 >::DotProductStencil( dim2 , dot2 , 0 , 0 );
	if( weakForm ) FiniteElements1D< Real , Type2 , Degree2 >::DotProduct< Type2 , Degree2 >::DotProductStencil( dim2 , biLap2 , 2 , 2 , negate );
	else           FiniteElements1D< Real , Type2 , Degree2 >::DotProduct< Type2 , Degree2 >::DotProductStencil( dim2 , biLap2 , 4 , 0 , negate );
...
{
	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::FullDotProductStencil dot1,lap1;
	FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::FullDotProductStencil dot2,lap2;

	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::DotProductStencil(dim1,dot1,0,0);
	if(weakForm)	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::DotProductStencil(dim1,lap1,1,1,negate);
	else			FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::DotProductStencil(dim1,lap1,2,0,negate);
	FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::DotProductStencil(dim2,dot2,0,0);
	if(weakForm)	FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::DotProductStencil(dim2,lap2,1,1,negate);
	else			FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::DotProductStencil(dim2,lap2,2,0,negate);
...
{
	FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::FullDotProductStencil dot1,dot2;
...
{
	FiniteElements1D<Real,Type1,Degree1>::FullProlongationStencil stencil1;
	FiniteElements1D<Real,Type2,Degree2>::FullProlongationStencil stencil2;
...
{
	FiniteElements1D<Real,Type1,Degree1>::FullRestrictionStencil stencil1;
	FiniteElements1D<Real,Type2,Degree2>::FullRestrictionStencil stencil2;
...
{
	SparseMatrix<MyReal> identity1,identity2,derivative1,derivative2;
	ww=FiniteElements1D<MyReal,Type1,Degree1>::DerivativeMatrix(w,derivative1);
	hh=FiniteElements1D<MyReal,Type2,Degree2>::DerivativeMatrix(h,derivative2);
	FiniteElements1D<MyReal,Type1,Degree1>::IdentityMatrix(w,identity1,derivative1.rowMajor);
	FiniteElements1D<MyReal,Type2,Degree2>::IdentityMatrix(h,identity2,derivative2.rowMajor);

	return
		FiniteElements2D<MyReal,Type1,Degree1>::TensorMatrixMultiply(w,ww,h,h,derivative1,identity2,in,dX) &&
		FiniteElements2D<MyReal,Type2,Degree2>::TensorMatrixMultiply(w,w,h,hh,identity1,derivative2,in,dY);
}
template<class Real,int Type1,int Degree1,int Type2,int Degree2>
template<class Data>
																   ...
																   int w,int h,int ww,int hh)
{
	...
	for(int i=0;i<h;i++)
	{
		...
		int dI=i+FiniteElements1D<Real,DERIVATIVE(Type2),Degree2-1>::DotProduct<Type2,Degree2>::Helper::StartOffset();
		int I =i+FiniteElements1D<Real,Type2,Degree2>::DotProduct<Type2,Degree2>::Helper::StartOffset();
		for(int j=0;j<w;j++)
		{
			Data temp=0;
			int jj;
			...
			int dJ=j+FiniteElements1D<Real,DERIVATIVE(Type1),Degree1-1>::DotProduct<Type1,Degree1>::Helper::StartOffset();
			int J =j+FiniteElements1D<Real,Type1,Degree1>::DotProduct<Type1,Degree1>::Helper::StartOffset();
